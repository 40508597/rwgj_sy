...
description: >
  ...
  五大机制：最大主动性设计、功能簇/功能树展开、交互完整性、多层递进设计、分治设计法。
---
# 任务架构 — AI 编程项目架构管理
...
- 功能树摘要：新增/修改节点、叶子功能、停止展开理由、架构落位状态
...
2. **功能簇/功能树展开**：把模糊需求展开为应有功能簇，再递归展开为可验收、可落位、可测试的功能树节点，最后落位到 architecture.json。
...
- 15 项一致性校验、禁止事项、精细化标准：读 `references/validation-checklist.md`
...
- `references/validation-checklist.md` — 关键规则、15 项校验、禁止事项
